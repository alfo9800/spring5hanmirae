      ...
      <div class="container-fluid">
       ...
       <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
         <div class="col-12"><!-- 그리드시스템중 12가로칼럼 width:100% -->
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <!-- html5에서 지원되는 유효성 검사: maxlength, minlegth, required, type="email" -->
                    <!-- html5지원 브라우저에서만 사용가능 그래서, jquery.validator라는 자바스크립트를 사용할 것 임.(나중에)-->
                  ...
                  <div class="form-group">
                   ...
                   <input value="${memberVO.email}" type="email" class="form-control" name="email" id="email" placeholder="이메일을 입력해주세요." required>
                  </div>
                  <div class="form-group">
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<a href="/admin/member/member_list?page=${pageVO.page}" class="btn btn-primary float-right mr-1">LIST ALL</a>              	
              	<a href="/admin/member/member_view?page=${pageVO.page}&user_id=${memberVO.user_id}" class="btn btn-info float-right mr-1">뒤로 가기</a>
          ...
          <!-- 폼내부에 버튼이 있어야지만 작동이 되어서 card-primary 밖으로 빼냄. -->
