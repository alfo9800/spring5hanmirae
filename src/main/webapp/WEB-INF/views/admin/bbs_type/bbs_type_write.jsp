          ...
          <form name="write_form" action="/admin/bbs_type/bbs_type_write" method="post">
			<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">게시판타입 등록</h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                  	...
                  	<input type="text" value="" class="form-control" name="board_type" id="board_type" placeholder="게시판탑입을 영문으로 입력해주세요." required>
                 </div>
        		 <div class="form-group">
                  ...
                  <div class="form-group">
                   <label for="board_sun">게시판출력 순서</label>
                   <input type="text" value="" class="form-control" name="board_sun" id="board_sun" placeholder="게시판 출력순서를 입력해주세요." required>
                  </div>
...
<!-- 현재 J쿼리 코어파일이 footer.jsp에 있기 때문에, 
	 JQuery실행은 코어 아래 쪽에 있어야 함. -->
<!-- 이렇게 상단부터 프로그램 내용을 해석-컴파일하는 과정의 언어를 인티프리티형 프로그램 언어라고 함. -->
<script>
