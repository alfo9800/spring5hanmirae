          ...
          <form name="update_form" action="/admin/bbs_type/bbs_type_update" method="post">
			<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">게시판타입 수정</h3>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <input type="text" value="${boardTypeVO.board_sun}" class="form-control" name="board_sun" id="board_sun" placeholder="게시판 출력순서를 입력해주세요." required>
                  </div>
